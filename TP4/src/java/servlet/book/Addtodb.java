...
/**
 * Servlet to add a book to database with the given parameters in session.
 * 
...
public class Addtodb extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ret = toolsServlet.servletTools.getinstance().htmlAdd2Database(tempTitle, tempAuthor, tempYear, myBookBean);
    ...
    public String getServletInfo() {
        return "This servlet allows to add a book to the database";
    }// </editor-fold>
